    ...
    <div class="container">
        <div class="one-movie">
            <div class="card mb-3 mt-3 one-movie__item">
                <div class="row g-3">
                    <div class="col-md-4">
                        <img src="<?php echo $storage->url($movie->image()) ?>" class="img-fluid rounded one-movie__image" alt="<?php echo $movie->name() ?>">
                        <?php if ($auth->check()) { ?>
                            <form action="/reviews/add" method="post" class="m-3 w-100">
                                ...
                                <button class="btn btn-primary mt-2">Make review</button>
                            </form>
                        <?php } else { ?>

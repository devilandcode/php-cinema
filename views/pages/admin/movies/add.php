...
<?php $view->component('start'); ?>
    <main>
        <div class="container">
            <h3 class="mt-3" style="color: white;">Add Movie</h3>
        ...
        <div class="container">
            <form action="/admin/movies/add" method="post" enctype="multipart/form-data" class="d-flex flex-column justify-content-center w-50 gap-2 mt-5 mb-5">
                ...
                <div class="row g-2">
                    <div class="col-md">
                        <div class="mb-3">
                            <label for="image" class="form-label" style="color: #ffc107">Image</label>
                ...
                <div class="row g-2">
                    <button class="btn btn-primary" style="background: #ffc107">Add</button>
                </div>
            </form>
        </div>
    </main>
